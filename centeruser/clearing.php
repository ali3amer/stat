<?php
session_start();
if(isset($_SESSION['centeruser']) && $_SESSION['center']) {
    $nonavbar = '';
    include 'init.php';
    ...
    $visits = getAllFrom('visit.ID, client, center, daate, center.name', 'visit', 'INNER JOIN center ON visit.center = center.ID WHERE visit.center = ' . $_SESSION['center'],  " AND vmonth = '$month' ", 'visit.ID', '');
    ...
    if($visits != null) {
        ...
        <div class="container-fluid reports" style="margin-top: 50px">
            ...
            <div><?php echo $state['name'] . ' ' . $month ?></div>
